const cacheName='phoenix-v7';
self.addEventListener('install',event=>{self.skipWaiting();event.waitUntil(caches.open(cacheName).then(cache=>cache.addAll(['/','/styles.css?v=5','/security.css?v=2','/history.css?v=1','/app.js?v=11','/install-phoenix.js?v=2','/manifest.webmanifest','/icons/phoenix-192.png','/icons/phoenix-512.png','/icons/phoenix-maskable-512.png'])))});
